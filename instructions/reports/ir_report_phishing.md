...
|-------------|---------------|-------------------|----------|------------------|---------------|-----------------|
| IR-2023-001 | Malware       | 2023-05-07 14:30  | High     | Alex Doe         | Casey Smith    | PC-001          |

## Incident Description

A phishing email was received by the user, Casey Smith, containing a malicious attachment. Upon opening the attachment, malware was executed on the affected system (PC-001). Antivirus flagged the attachment as a known-malicious sample.
...
|-------------|-----------------------------------------------|--------------|
| 14:32       | Initial identification of the malware incident | Alex Doe     |
| 14:35       | User informed and advised to disconnect PC    | Alex Doe     |
| 14:40       | Affected system isolated from the network     | Alex Doe     |
| 14:45       | System backup initiated                       | Alex Doe     |
| 15:00       | Malware analysis and identification           | Alex Doe     |
| 15:15       | Malware removal and system restoration        | Alex Doe     |
| 15:45       | System integrity and functionality confirmed  | Alex Doe     |
| 16:00       | User informed and system returned to user     | Alex Doe     |
