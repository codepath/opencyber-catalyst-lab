...
|-------------|---------------|-------------------|----------|------------------|-----------------|---------------|
| IR-2023-003 | Brute Force   | 2023-05-07 18:00  | High     | Riley Adams       | Server-001      | Persistence malware |
...
| 18:10       | Intrusion Detection System alerts reviewed      | Riley Adams   |
| 18:15       | Affected system isolated from the network       | Riley Adams   |
| 18:20       | System backup initiated                         | Riley Adams   |
| 18:35       | Malware analysis and identification             | Riley Adams   |
| 18:50       | Malware removal and system restoration          | Riley Adams   |
| 19:20       | System integrity and functionality confirmed    | Riley Adams   |
| 19:30       | Affected system returned to normal operation    | Riley Adams   |
